...
public:
     ...
     */
    virtual std::vector<FloatArray> giveFluxVectors(const std::vector<FloatArray> &vGrads, GaussPoint *gp, TimeStep *tStep) const;
    //@{
    virtual std::tuple<FloatArrayF< 9 >,FloatArrayF< 3 >> give_FluxVectors_P_B_3d(const FloatArrayF< 9 > &reducedF, const FloatArrayF< 9 > &reducedH, GaussPoint *gp, TimeStep *tStep) const;
        virtual std::tuple<FloatArrayF< 5 >,FloatArrayF< 2 >> give_FluxVectors_P_B_PlaneStrain(const FloatArrayF< 5 > &reducedF, const FloatArrayF< 2 > &reducedH, GaussPoint *gp, TimeStep *tStep) const = 0;
    //@}
    /**
     ...
     */
	virtual void giveCharMaterialMatrix_dPdF_dBdH_dPdH(std::vector<FloatMatrix> &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep);
     ...
     */
    //@{
    virtual std::tuple<FloatMatrixF< 9, 9 >,FloatMatrixF< 3, 3 >,FloatMatrixF< 9, 3 >> give_dPdF_dBdH_dPdH_3d(MatResponseMode mode, GaussPoint *gp, TimeStep *tStep) const;
    virtual std::tuple<FloatMatrixF< 5, 5 >,FloatMatrixF< 2, 2 >,FloatMatrixF< 5, 3 >> give_dPdF_dBdH_dPdH_PlaneStrain(MatResponseMode mode, GaussPoint *gp, TimeStep *tStep) const;
    //@}
};
