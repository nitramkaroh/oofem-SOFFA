...
public:
  ...
  ////////////////////////////////////////////////////
     ...
     virtual std::tuple<FloatArrayF<5>, FloatArrayF<8> > give_RotationGradient_FirstPKStressVector_SecondOrderStressVector_PlaneStrain( const FloatArrayF<5> &vF, const FloatArrayF<8> &vGradF, GaussPoint *gp, TimeStep *tStep ) { return std::make_tuple( zeros<5>(), zeros<8>() ); }
     virtual std::tuple<FloatMatrixF<5, 5>, FloatMatrixF<5, 8>, FloatMatrixF<8, 5>, FloatMatrixF<8, 8> > give_RotationGradient_ConstitutiveMatrices_PlaneStrain( MatResponseMode mode, GaussPoint *gp, TimeStep *tStep ) { return std::make_tuple( FloatMatrixF<5, 5>(), FloatMatrixF<5, 8>(), FloatMatrixF<8, 5>(), FloatMatrixF<8, 8>() ); }
