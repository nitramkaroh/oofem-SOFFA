...
HardMagneticMooneyRivlinCompressibleMaterial::HardMagneticMooneyRivlinCompressibleMaterial(int n, Domain *d) : MagnetoElasticMaterial(n, d), BaseHyperElasticMaterial()
{ }
...
void
HardMagneticMooneyRivlinCompressibleMaterial::initializeFrom(InputRecord &ir)
{
