 ...
 * @note
 */
  class MooneyRivlinHardMagnetic : public MooneyRivlinCompressibleMaterial, HardMagneticInterface
{
protected:
    // Material parameters
    FloatArrayF<3> B_app;
...
public:
    MooneyRivlinHardMagnetic( int n, Domain *d ) :
      MooneyRivlinCompressibleMaterial( n, d ){}, HardMagneticInterface(){};
...
private:
  ...
  FloatArrayF< 3 >giveMagneticInductionVector_3d(const FloatArrayF<3> &H, const FloatArrayF< 9 > &vF, GaussPoint *gp, TimeStep *tStep) const override;
