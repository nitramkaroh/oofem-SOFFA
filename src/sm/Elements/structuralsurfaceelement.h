...
#ifndef structuralsurfaceelement_h
#define structuralsurfaceelement_h
...
/**
 * Base class for surface elements to incorporate surface tension
 */
class OOFEM_EXPORT StructuralSurfaceElement : public StructuralElement
{
protected:
...
public:
     ...
     */
    StructuralSurfaceElement( int n, Domain *d );
    /// Destructor.
    virtual ~StructuralSurfaceElement();
