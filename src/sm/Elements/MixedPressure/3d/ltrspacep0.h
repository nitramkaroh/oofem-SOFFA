...
#define _IFT_LTRSpaceP0_Name "ltrspacep0"

namespace oofem {
class ElementDofManager;

  
class LTRSpaceP0 : public LTRSpace, public BaseMixedPressureElement
{
protected:
    /// The extra dofs from the bubble
    std :: unique_ptr< ElementDofManager > pressureDof;

public:
    LTRSpaceP0(int n, Domain *d);
    virtual ~LTRSpaceP0() { }
...
public:
    const char *giveInputRecordName() const override { return _IFT_LTRSpaceP0_Name; }
    const char *giveClassName() const override { return "LTRSpaceP0"; }
  ...
  int giveNumberOfDofs() override { return 13; }
