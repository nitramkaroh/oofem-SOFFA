...
public:
    ...
    */
    ...
    const char *giveClassName() const override { return "NlBeamInternalContact"; }
    const char *giveInputRecordName() const override { return _IFT_NlBeamInternalContact_Name; }
