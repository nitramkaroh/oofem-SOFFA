...
///@name Input fields for HardMagneticBodyLoad
//@{
#define _IFT_HardMagneticBodyLoad_Name "hardmagneticbodyload"
#define _IFT_HardMagneticBodyLoad_mu_0 "mu_0"
#define _IFT_HardMagneticBodyLoad_b_ext "b_ext"
#define _IFT_HardMagneticBodyLoad_mjump "mjump"
#define _IFT_HardMagneticBodyLoad_ltf "loadtimefunction" //load time function for applied field
//@}

namespace oofem {
/**
 * This class implements a hard magnetic body load
 *
...
class HardMagneticBodyLoad : public ActiveBoundaryCondition {
...
public:
    ...
    /// <param name="n"></param>
    /// <param name="d"></param>
    HardMagneticBodyLoad( int n, Domain *d ) :
        ActiveBoundaryCondition( n, d ) {}
    /// Destructor.
    virtual ~HardMagneticBodyLoad() {}
    ...
    const char *giveInputRecordName() const override { return _IFT_HardMagneticBodyLoad_Name; }
    const char *giveClassName() const override { return "HardMagneticBodyLoad"; }
