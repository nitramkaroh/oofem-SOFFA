...
namespace FTensor
{
//Universal A(i, j, k, l, )*B(m, n, ) single contraction
    ...
    for(int xx = 0; xx < DimX; ++xx)
      {
        ...
        result += Permutation4<DimA, DimB, DimC, DimX, a, b, c, x>().eval(
          iterA, N1, N2, N3, xx) * Permutation2<DimX, DimY, x, y>().eval(iterB, xx, N4);
      }
    return result;
  }
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim0, Dim4, i, j, k, l, i, m, Dim1, Dim2, Dim3, Dim0, Dim4, j, k, l, i, m>;
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim0, i, j, k, l, m, i, Dim1, Dim2, Dim3, Dim0, Dim4, j, k, l, i, m>;
  return Tensor4_Expr<TensorExpr, typename promote<T,U>::V, Dim1, Dim2, Dim3, Dim4, j, k, l, m>(TensorExpr(a, b));
}
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim1, Dim4, i, j, k, l, j, m, Dim0, Dim2, Dim3, Dim1, Dim4, i, k, l, j, m>;
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim1, i, j, k, l, m, j, Dim0, Dim2, Dim3, Dim1, Dim4, i, k, l, j, m>;
  return Tensor4_Expr<TensorExpr, typename promote<T,U>::V, Dim0, Dim2, Dim3, Dim4, i, k, l, m>(TensorExpr(a, b));
}
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim2, Dim4, i, j, k, l, k, m, Dim0, Dim1, Dim3, Dim2, Dim4, i, j, l, k, m>;
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim2, i, j, k, l, m, k, Dim0, Dim1, Dim3, Dim2, Dim4, i, j, l, k, m>;
  return Tensor4_Expr<TensorExpr, typename promote<T,U>::V, Dim0, Dim1, Dim3, Dim4, i, j, l, m>(TensorExpr(a, b));
}
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim3, Dim4, i, j, k, l, l, m, Dim0, Dim1, Dim2, Dim3, Dim4, i, j, k, l, m>;
...
{
  using TensorExpr
    = Tensor4_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim3, i, j, k, l, m, l, Dim0, Dim1, Dim2, Dim3, Dim4, i, j, k, l, m>;
  return Tensor4_Expr<TensorExpr, typename promote<T,U>::V, Dim0, Dim1, Dim2, Dim4, i, j, k, m>(TensorExpr(a, b));
}
