...
namespace FTensor
{
  ...
  public:
    ...
    Tensor5_plus_Tensor5(const Tensor5_Expr<A, T, Dim0_0, Dim1_0, Dim2_0,
  ...
  {
    using TensorExpr
      = Tensor5_plus_Tensor5<A, B, T, U, Dim0_0, Dim1_0, Dim2_0, Dim3_0, Dim4_0,
