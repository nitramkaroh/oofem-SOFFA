...
namespace FTensor
{
//Universal A(i, j, k, l, m, )*B(n, o, ) double contraction
template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2, int Dim3, int Dim4, int Dim5, int Dim6, char i, char j, char k, char l, char m, char n, char o, int DimA, int DimB, int DimC, int DimX, int DimY, char a, char b, char c, char x, char y>
      ...
      for(int yy = 0; yy < DimY; ++yy)
        {
          ...
          result += Permutation5<DimA, DimB, DimC, DimX, DimY, a, b, c, x, y>().eval(
            iterA, N1, N2, N3, xx, yy) * Permutation2<DimX, DimY, x, y>().eval(iterB, xx, yy);
        }
    return result;
  }
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim1, Dim0, i, j, k, l, m, j, i, Dim2, Dim3, Dim4, Dim0, Dim1, k, l, m, i, j>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim2, Dim0, i, j, k, l, m, k, i, Dim1, Dim3, Dim4, Dim0, Dim2, j, l, m, i, k>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim3, Dim0, i, j, k, l, m, l, i, Dim1, Dim2, Dim4, Dim0, Dim3, j, k, m, i, l>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim4, Dim0, i, j, k, l, m, m, i, Dim1, Dim2, Dim3, Dim0, Dim4, j, k, l, i, m>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim2, Dim1, i, j, k, l, m, k, j, Dim0, Dim3, Dim4, Dim1, Dim2, i, l, m, j, k>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim3, Dim1, i, j, k, l, m, l, j, Dim0, Dim2, Dim4, Dim1, Dim3, i, k, m, j, l>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim4, Dim1, i, j, k, l, m, m, j, Dim0, Dim2, Dim3, Dim1, Dim4, i, k, l, j, m>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim3, Dim2, i, j, k, l, m, l, k, Dim0, Dim1, Dim4, Dim2, Dim3, i, j, m, k, l>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim4, Dim2, i, j, k, l, m, m, k, Dim0, Dim1, Dim3, Dim2, Dim4, i, j, l, k, m>;
...
{
  using TensorExpr
    = Tensor5_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim4, Dim3, i, j, k, l, m, m, l, Dim0, Dim1, Dim2, Dim3, Dim4, i, j, k, l, m>;
