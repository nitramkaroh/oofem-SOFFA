...
namespace FTensor
{
  // A(i,j,k,l, m) * B(n,o) single contraction
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            ...
            char m, char n, char o, int DimA, int DimB, int DimC, int DimD, int DimX, int DimY,
            char a, char b, char c, char d, char x, char y>
      ...
      for(int xx = 0; xx < DimX; ++xx)
        {
          ...
          result += Permutation5<DimA, DimB, DimC, DimD, DimX, a, b, c, d, x>().eval(
                      iterA, N1, N2, N3, N4, xx)
                    * Permutation2<DimX, DimY, x, y>().eval(iterB, xx, N5);
        }
      return result;
    }
 ...
 // A(i, j, k, l, m, )*B(i, n, )
  ...
  {
    using TensorExpr
        = Tensor5_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim0, i, j, k, l, m, n, i, Dim1, Dim2, Dim3, Dim4, Dim5, Dim0, j, k, l, m, n, i>;
    return Tensor5_Expr<TensorExpr, typename promote<T, U>::V, Dim1, Dim2, Dim3, Dim4, Dim5, j, k, l, m, n>( TensorExpr( a, b ) );
  }
  ...
  {
    using TensorExpr
        = Tensor5_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim1, i, j, k, l, m, n, j, Dim0, Dim2, Dim3, Dim4, Dim5, Dim1, i, k, l, m, n, j>;
    return Tensor5_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim2, Dim3, Dim4, Dim5, i, k, l, m, n>( TensorExpr( a, b ) );
  }
  ...
  {
    using TensorExpr
        = Tensor5_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim2, i, j, k, l, m, n, k, Dim0, Dim1, Dim3, Dim4, Dim5, Dim2, i, j, l, m, n, k>;
    return Tensor5_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim3, Dim4, Dim5, i, j, l, m, n>( TensorExpr( a, b ) );
  }
  ...
  {
    using TensorExpr
        = Tensor5_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim3, i, j, k, l, m, n, l, Dim0, Dim1, Dim2, Dim4, Dim5, Dim3, i, j, k, m, n, l>;
    return Tensor5_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim2, Dim4, Dim5, i, j, k, m, n>( TensorExpr( a, b ) );
  }
  ...
  {
    using TensorExpr
        = Tensor5_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim4, i, j, k, l, m, n, m, Dim0, Dim1, Dim2, Dim3, Dim5, Dim4, i, j, k, l, n, m>;
    return Tensor5_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim2, Dim3, Dim5, i, j, k, l, n>( TensorExpr( a, b ) );
  }
