/* Declare a wrapper class for generic rank 7 Tensor expressions. */

#pragma once

#include "Tensor7_minus_Tensor7.hpp"
...
namespace FTensor
{
  ...
  template <class A, class T, int Dim0, int Dim1, int Dim2, int Dim3, int Dim4, int Dim5, int Dim6, char i,
            char j, char k, char l, char m, char n, char o>
  class Tensor7_Expr<Tensor7<A, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6>, T, Dim0, Dim1, Dim2,
                     Dim3, Dim4, Dim5, Dim6, i, j, k, l, m, n, o>
  {
    Tensor7<A, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6> &iter;
  ...
  public:
    ...
    template <class B, class U, int Dim1_0, int Dim1_1, int Dim1_2, int Dim1_3, int Dim1_4, int Dim1_5, int Dim1_6,
              char i_1, char j_1, char k_1, char l_1, char m_1, char n_1, char o_1>
    auto &equals(const Tensor7_Expr<B, U, Dim1_0, Dim1_1, Dim1_2, Dim1_3, Dim1_4, Dim1_5, Dim1_6, i_1,
                                    j_1, k_1, l_1, m_1, n_1, o_1> &rhs)
    {
    ...
    template <class B, class U, int Dim1_0, int Dim1_1, int Dim1_2, int Dim1_3, int Dim1_4, int Dim1_5, int Dim1_6,
              char i_1, char j_1, char k_1, char l_1, char m_1, char n_1, char o_1>
    auto &operator=(const Tensor7_Expr<B, U, Dim1_0, Dim1_1, Dim1_2, Dim1_3, Dim1_4, Dim1_5, Dim1_6,
                                       i_1, j_1, k_1, l_1, m_1, n_1, o_1> &rhs)
    {
      return equals(rhs);
    }

    auto &
    operator=(const Tensor7_Expr<Tensor7<A, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6>, T, Dim0,
                                 Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, i, j, k, l, m, n, o> &rhs)
    {
      return equals(rhs);
    }
