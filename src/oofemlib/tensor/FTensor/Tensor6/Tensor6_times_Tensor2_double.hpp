      ...
      for(int yy = 0; yy < DimY; ++yy)
        {
          ...
          result += Permutation6<DimA, DimB, DimC, DimD, DimX, DimY, a, b, c, d, x, y>().eval(
            iterA, N1, N2, N3, N4, xx, yy) * Permutation2<DimX, DimY, x, y>().eval(iterB, xx, yy);
        }
    return result;
  }
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim1, Dim0, i, j, k, l, m, n, j, i, Dim2, Dim3, Dim4, Dim5, Dim0, Dim1, k, l, m, n, i, j>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim2, Dim0, i, j, k, l, m, n, k, i, Dim1, Dim3, Dim4, Dim5, Dim0, Dim2, j, l, m, n, i, k>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim3, Dim0, i, j, k, l, m, n, l, i, Dim1, Dim2, Dim4, Dim5, Dim0, Dim3, j, k, m, n, i, l>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim4, Dim0, i, j, k, l, m, n, m, i, Dim1, Dim2, Dim3, Dim5, Dim0, Dim4, j, k, l, n, i, m>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim5, Dim0, i, j, k, l, m, n, n, i, Dim1, Dim2, Dim3, Dim4, Dim0, Dim5, j, k, l, m, i, n>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim2, Dim1, i, j, k, l, m, n, k, j, Dim0, Dim3, Dim4, Dim5, Dim1, Dim2, i, l, m, n, j, k>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim3, Dim1, i, j, k, l, m, n, l, j, Dim0, Dim2, Dim4, Dim5, Dim1, Dim3, i, k, m, n, j, l>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim4, Dim1, i, j, k, l, m, n, m, j, Dim0, Dim2, Dim3, Dim5, Dim1, Dim4, i, k, l, n, j, m>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim5, Dim1, i, j, k, l, m, n, n, j, Dim0, Dim2, Dim3, Dim4, Dim1, Dim5, i, k, l, m, j, n>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim3, Dim2, i, j, k, l, m, n, l, k, Dim0, Dim1, Dim4, Dim5, Dim2, Dim3, i, j, m, n, k, l>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim4, Dim2, i, j, k, l, m, n, m, k, Dim0, Dim1, Dim3, Dim5, Dim2, Dim4, i, j, l, n, k, m>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim5, Dim2, i, j, k, l, m, n, n, k, Dim0, Dim1, Dim3, Dim4, Dim2, Dim5, i, j, l, m, k, n>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim4, Dim3, i, j, k, l, m, n, m, l, Dim0, Dim1, Dim2, Dim5, Dim3, Dim4, i, j, k, n, l, m>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim5, Dim3, i, j, k, l, m, n, n, l, Dim0, Dim1, Dim2, Dim4, Dim3, Dim5, i, j, k, m, l, n>;
...
{
  using TensorExpr
    = Tensor6_times_Tensor2_double<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim5, Dim4, i, j, k, l, m, n, n, m, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, i, j, k, l, m, n>;
