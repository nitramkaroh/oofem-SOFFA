// Subtracts Tensor6 - Tensor6 -> Tensor6
...
namespace FTensor
{
  ...
  public:
    ...
    Tensor6_minus_Tensor6(const Tensor6_Expr<A, T, Dim0_0, Dim1_0, Dim2_0,
  ...
  {
    using TensorExpr
      = Tensor6_minus_Tensor6<A, B, T, U, Dim0_0, Dim1_0, Dim2_0, Dim3_0, Dim4_0, Dim5_0,
