  ...
  typename promote<T, U>::V operator()( const int N1, const int N2, const int N3, const int N4, const int N5, const int N6 ) const
  {
    ...
    for ( int xx = 0; xx < DimX, ++xx ) {
      ...
      result += Permutation6<DimA, DimB, DimC, DimD, DimE, DimX, a, b, c, d, e, x>().eval(
                    iterA, N1, N2, N3, N4, N5, xx )
          * Permutation2<DimX, DimY, x, y>().eval( iterB, xx, N6 );
    }
    return result;
  }
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim0, i, j, k, l, m, n, o, i, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim0, j, k, l, m, n, o, i>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, j, k, l, m, n, o>( TensorExpr( a, b ) );
}
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim1, i, j, k, l, m, n, o, j, Dim0, Dim2, Dim3, Dim4, Dim5, Dim6, Dim1, i, k, l, m, n, o, j>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim2, Dim3, Dim4, Dim5, Dim6, i, k, l, m, n, o>( TensorExpr( a, b ) );
}
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim2, i, j, k, l, m, n, o, k, Dim0, Dim1, Dim3, Dim4, Dim5, Dim6, Dim2, i, j, l, m, n, o, k>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim3, Dim4, Dim5, Dim6, i, j, l, m, n, o>( TensorExpr( a, b ) );
}
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim3, i, j, k, l, m, n, o, l, Dim0, Dim1, Dim2, Dim4, Dim5, Dim6, Dim3, i, j, k, m, n, o, l>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim2, Dim4, Dim5, Dim6, i, j, k, m, n, o>( TensorExpr( a, b ) );
}
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim4, i, j, k, l, m, n, o, m, Dim0, Dim1, Dim2, Dim3, Dim5, Dim6, Dim4, i, j, k, l, n, o, m>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim2, Dim3, Dim5, Dim6, i, j, k, l, n, o>( TensorExpr( a, b ) );
}
...
{
  using TensorExpr
      = Tensor6_times_Tensor2_single<A, B, T, U, Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6, Dim5, i, j, k, l, m, n, o, n, Dim0, Dim1, Dim2, Dim3, Dim4, Dim6, Dim5, i, j, k, l, m, o, n>;
  return Tensor6_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1, Dim2, Dim3, Dim4, Dim6, i, j, k, l, m, o>( TensorExpr( a, b ) );
}
